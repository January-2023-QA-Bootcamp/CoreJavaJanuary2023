...
public class C_creating_folder_and_file {
	...
	public static void main(String[] args) {
		...
		if(folder.exists()) {
			...
			// An exception can be occur while creating file, so, use try catch block or declare throws
			...
			if (file.exists()) {
				...
				System.out.println("Exception occured, That's why file is not created");
			}
